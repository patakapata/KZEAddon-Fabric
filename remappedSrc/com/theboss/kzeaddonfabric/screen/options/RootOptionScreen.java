...
public class RootOptionScreen extends Screen {
    ...
    private ClickableWidget widgets;
    private ClickableWidget glowColor;
    private ClickableWidget _PENDING;
    private ClickableWidget other;

    private ClickableWidget close;
