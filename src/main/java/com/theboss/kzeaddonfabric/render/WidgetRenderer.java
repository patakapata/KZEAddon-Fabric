...
import com.theboss.kzeaddonfabric.KZEInformation;
import com.theboss.kzeaddonfabric.enums.Anchor;
import com.theboss.kzeaddonfabric.enums.WeaponSlot;
import com.theboss.kzeaddonfabric.render.widgets.*;
...
public class WidgetRenderer {
    ...
    public void openLiteralWidgetsScreen() {
        MinecraftClient mc = MinecraftClient.getInstance();
        LiteralWidgetsScreen screen = new LiteralWidgetsScreen(this.literalWidgets);
    ...
    public void openArrangementScreen(int index) {
        MinecraftClient mc = MinecraftClient.getInstance();
        WidgetArrangementScreen screen = new WidgetArrangementScreen(this.literalWidgets.get(index));
        screen.setParent(mc.currentScreen);
        screen.open(mc);
    }
