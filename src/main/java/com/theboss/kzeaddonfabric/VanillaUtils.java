...
public class VanillaUtils {
    ...
    public static Vec3d toAbsoluteCoordinate(DefaultPosArgument pos) {
    ...
    public static HitResult raycastIgnoreBlock(Entity entity, double distance) {
        ...
        if (entityHitResult == null) {
            ...
            KZEAddon.info("raycast > Entity found");
            KZEAddon.info("raycast > Distance: " + String.format("%.2f", entity.distanceTo(entityHitResult.getEntity())));
            result = entityHitResult;
        }
        time += System.currentTimeMillis();
        KZEAddon.info("raycast > Elapsed time: " + String.format("%.2f", time / 1000.0));
        return result;
    }
